...
# 55 "MCAL_Layer/CCP/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 1 "MCAL_Layer/CCP/../Timer2/hal_timer2.h" 1
# 31 "MCAL_Layer/CCP/../Timer2/hal_timer2.h"
typedef enum{
...
Std_ReturnType CCP_Compare_Mode_Set_Value(const ccp_t *_ccp_obj, uint16 _compare_value){
    ...
    if(((void*)0) == _ccp_obj){
        ...
        CCP_PERIOD_REG_T capture_temp_val = {.ccpr_low = 0, .ccpr_high = 0};
