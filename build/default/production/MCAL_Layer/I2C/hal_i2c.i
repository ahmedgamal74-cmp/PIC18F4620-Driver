...
# 55 "MCAL_Layer/I2C/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 82 "MCAL_Layer/I2C/hal_i2c.h"
typedef struct{
    uint32 i2c_clock;
    uint8 i2c_slave_address;
    uint8 i2c_mode_cfg;
    uint8 i2c_mode_MAorSL : 1;
    uint8 i2c_slew_rate_en : 1;
    uint8 i2c_SMBus_control_en : 1;
    uint8 i2c_general_call_en : 1;
    uint8 i2c_master_receive_mode_en : 1;
...
Std_ReturnType I2C_Init(const i2c_t *i2c_obj){
    ...
    if(((void*)0) == i2c_obj){
        ...
        if(i2c_obj->i2c_cfg.i2c_mode_MAorSL == 1){

            SSPCON1bits.SSPM = i2c_obj->i2c_cfg.i2c_mode_cfg;

            SSPADD = (uint8)(((8000000UL / 4.0) / i2c_obj->i2c_cfg.i2c_clock) - 1);
        }
        else if(i2c_obj->i2c_cfg.i2c_mode_MAorSL == 0){

            if(1 == i2c_obj->i2c_cfg.i2c_general_call_en){
                (SSPCON2bits.GCEN = 1);
            }
            else if(0 == i2c_obj->i2c_cfg.i2c_general_call_en){
                (SSPCON2bits.GCEN = 0);
            }
            else{}
        ...
        if(0 == i2c_obj->i2c_cfg.i2c_slew_rate_en){
            (SSPSTATbits.SMP = 0);
        }
        else if(1 == i2c_obj->i2c_cfg.i2c_slew_rate_en){
            (SSPSTATbits.SMP = 1);
        }
        else{}

        if(1 == i2c_obj->i2c_cfg.i2c_SMBus_control_en){
            (SSPSTATbits.CKE = 1);
        }
        else if(0 == i2c_obj->i2c_cfg.i2c_SMBus_control_en){
            (SSPSTATbits.CKE = 0);
        }
        else{}
# 118 "MCAL_Layer/I2C/hal_i2c.c"
        (SSPCON1bits.SSPEN = 1);
    }
    return ret;
}
...
void I2C_ISR(void){
# 271 "MCAL_Layer/I2C/hal_i2c.c"
}

void I2C_BC_ISR(void){
# 282 "MCAL_Layer/I2C/hal_i2c.c"
}
