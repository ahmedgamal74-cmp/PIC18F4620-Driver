...
# 55 "MCAL_Layer/ADC/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static __attribute__((inline)) void select_result_fromat(const adc_conf_t *_adc);
