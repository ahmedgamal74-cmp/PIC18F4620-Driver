...
# 35 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 55 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 62 "MCAL_Layer/Timer3/hal_timer3.c"
        (T3CONbits.TMR3ON = 1);
    }
    return ret;
}
...
Std_ReturnType TIMER3_Read_Value(const timer3_t *_timer, uint16 *_value){
    ...
    if((((void*)0) == _timer) || (((void*)0) == _value)){
        ...
        *_value = (uint16)(l_tmr3Low + (l_tmr3High << 8));
    }
    return ret;
}
