...
# 35 "MCAL_Layer/Timer0/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 55 "MCAL_Layer/Timer0/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 65 "MCAL_Layer/Timer0/hal_timer0.c"
        (T0CONbits.TMR0ON = 1);
    }
    return ret;
}
...
Std_ReturnType TIMER0_Read_Value(const timer0_t *_timer, uint16 *_value){
    ...
    if((((void*)0) == _timer) || (((void*)0) == _value)){
        ...
        *_value = (uint16)(l_tmr0Low + (l_tmr0High << 8));
    }
    return ret;
}
