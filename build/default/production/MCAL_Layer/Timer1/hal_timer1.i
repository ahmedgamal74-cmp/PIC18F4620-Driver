...
# 35 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 55 "MCAL_Layer/Timer1/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static __attribute__((inline)) void Timer1_Mode_config(const timer1_t *_timer);
...
# 60 "MCAL_Layer/Timer1/hal_timer1.c"
        (T1CONbits.TMR1ON = 1);
    }
    return ret;
}
...
Std_ReturnType TIMER1_Read_Value(const timer1_t *_timer, uint16 *_value){
    ...
    if((((void*)0) == _timer) || (((void*)0) == _value)){
        ...
        *_value = (uint16)(l_tmr1Low + (l_tmr1High << 8));
    }
    return ret;
}
