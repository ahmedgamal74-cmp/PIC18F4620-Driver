...
# 35 "MCAL_Layer/Timer2/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 55 "MCAL_Layer/Timer2/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 8 "MCAL_Layer/Timer2/hal_timer2.c" 2
    ...
    void (* TMR2_InterruptHandler)(void) = ((void*)0);
...
# 59 "MCAL_Layer/Timer2/hal_timer2.c"
        (T2CONbits.TMR2ON = 1);
    }
    return ret;
}
