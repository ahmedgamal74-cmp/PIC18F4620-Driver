...
static InterruptHandler RB4_InterruptHandler_ChangedTOHigh = ((void*)0);
static InterruptHandler RB4_InterruptHandler_ChangedTOLow = ((void*)0);
static InterruptHandler RB5_InterruptHandler_ChangedTOHigh = ((void*)0);
static InterruptHandler RB5_InterruptHandler_ChangedTOLow = ((void*)0);
static InterruptHandler RB6_InterruptHandler_ChangedTOHigh = ((void*)0);
static InterruptHandler RB6_InterruptHandler_ChangedTOLow = ((void*)0);
static InterruptHandler RB7_InterruptHandler_ChangedTOHigh = ((void*)0);
static InterruptHandler RB7_InterruptHandler_ChangedTOLow = ((void*)0);
...
Std_ReturnType Interrupt_RBx_Init(const interrupt_RBx_t *int_obj){
    ...
    if(((void*)0) == int_obj){
        ...
        (INTCONbits.RBIF = 0);
# 239 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 318 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);
...
# 334 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);
