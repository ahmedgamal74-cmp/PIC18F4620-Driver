...
# 64 "ECU_Layer/Chr_LCD/ecu_chr_lcd.h"
typedef struct{
    pin_config_t lcd_rs;
    pin_config_t lcd_en;
...
# 100 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_char_data_pos(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column, uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 160 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column, const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
Std_ReturnType lcd_8bit_send_command(const chr_lcd_8bit_t *lcd, uint8 command){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_8bits_counter = 0;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
    }
    else{
        ret = gpio_pin_write_logic(&(lcd->lcd_rs), GPIO_LOW);
        for(l_8bits_counter = 0; l_8bits_counter < 8; l_8bits_counter++){
            ret = gpio_pin_write_logic(&(lcd->lcd_data[l_8bits_counter]), (command >> l_8bits_counter) & ((uint8)0x01));
        }
...
Std_ReturnType lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd, uint8 data){
    ...
    if(((void*)0) == lcd){
        ...
        ret = gpio_pin_write_logic(&(lcd->lcd_rs), GPIO_HIGH);
        for(l_8bits_counter = 0; l_8bits_counter < 8; l_8bits_counter++){
            ret = gpio_pin_write_logic(&(lcd->lcd_data[l_8bits_counter]), (data >> l_8bits_counter) & ((uint8)0x01));
        }
        ret = lcd_8bits_send_enable_signal(lcd);
    }
    return ret;
...
# 328 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column, const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_lcd_counter = 0;
    if(((void*)0) == lcd){
...
# 409 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_send_4bits(const chr_lcd_4bit_t *lcd, uint8 _command){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_4bits_counter = 0;
    for(l_4bits_counter = 0; l_4bits_counter < 4; l_4bits_counter++){
        ret = gpio_pin_write_logic(&(lcd->lcd_data[l_4bits_counter]), (_command >> l_4bits_counter) & ((uint8)0x01));
    }
    return ret;
}
...
# 438 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_4bits_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    column--;
    switch(row){
...
# 471 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_8bits_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    column--;
    switch(row){
